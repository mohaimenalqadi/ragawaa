            ...
            <div className="container-custom relative z-30 pt-32 pb-48">
                <div className="max-w-3xl">
                    ...
                    >
                        نظافة تبهرك
                        <br />
                        <span className="text-white/90">بلمسة رغوة ✨</span>
                    </motion.h1>
                    ...
                    <motion.p
                        ...
                        className="text-xl md:text-2xl text-white/80 mb-12 max-w-xl leading-relaxed"
                    >
                        تنظيف منازل • غسيل سجاد • غسيل سيارات
                    </motion.p>
                    ...
                    <motion.div
                        ...
                        className="mt-16 flex flex-wrap items-center gap-8 text-white"
                    >
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-white/70 font-bold mr-9">في ليبيا</span>
                        </div>
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-white/70 font-bold mr-9">تبدأ أسعارنا</span>
                        </div>
                    </motion.div>
                </div>
            </div>
